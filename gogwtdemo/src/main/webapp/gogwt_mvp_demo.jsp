...
<html>
  ...
  <c:choose> 
      <c:when test="${empty param.nocacheSwitch}"> 
         <c:set var="nocacheSwitch" value="case1"/>
      </c:when> 
      
      <c:otherwise> 
         <c:set var="nocacheSwitch" value="${param.nocacheSwitch}"/>
      </c:otherwise> 
  </c:choose> 
  ...
  <body>
   ...
   <c:choose>
    ...
    <c:when test="${nocacheSwitch eq 'case2'}">
       ...
       <base href="<%=request.getContextPath()%>/com.gogwt.demo.gwt.mvp.MVPUiBinderModule/" />
       <script type="text/javascript" language="javascript">
          <%@ include file="/com.gogwt.demo.gwt.mvp.MVPUiBinderModule/com.gogwt.demo.gwt.mvp.MVPUiBinderModule.nocache.js" %>
       </script>
    ...
    <c:when test="${nocacheSwitch eq 'case3'}">       
       ...
       <gogwt:permutation module="com.gogwt.demo.gwt.mvp.MVPUiBinderModule" >
