...
/**
 * <code><B>AbstractControllerConfigAccessor<code><B>
 * 
 * <p/>
 */

public abstract class AbstractControllerConfigAccessor implements ControllerConfigAccessor {
	protected static String[] pageTokens;
	protected Map<String, ControllerConfig> pageConfigInstances;
	...
	public Map<String, ControllerConfig> getPageConfigInstances() {
