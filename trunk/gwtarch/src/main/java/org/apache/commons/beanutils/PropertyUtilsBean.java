            ...
            for (int i = 0; i < origDescriptors.length; i++) {
                ...
                if (isReadable(orig, name) && isWriteable(dest, name)) {
                    try {
                    	...
                    	System.out.println("Error writing to '" + name + "' on class '" + dest.getClass() + "'" +  e.getMessage());
                    	e.printStackTrace();
                ...
                if (descriptor.getReadMethod() == null) {
                    ...
                    if (readMethod != null) {
                        try {
                        	...
                        	System.out.println("Error setting indexed property read method, " + e.getMessage());
                        }
                    }
                }
                if (descriptor.getWriteMethod() == null) {
                    ...
                    if (writeMethod != null) {
                        try {
                        	...
                        	System.out.println("Error setting indexed property write method" + e.getMessage());
                        }
                    }
                }
            }
    ...
    private Object invokeMethod(
        ...
        try {
            ...
            if (!BeanUtils.initCause(e, cause)) {
            	...
            	System.out.println("Method invocation failed: " + cause.getMessage());
            }
            throw e;
