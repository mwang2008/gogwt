...
function getMarkerImage(iconColor) {
   ...
   if (!gicons[iconColor]) {
      gicons[iconColor] = 
         new google.maps.MarkerImage("http://labs.google.com/ridefinder/images/mm_20_"+ iconColor +".png",
...
function getXmlFile(filename) {
   ...
   downloadUrl(filename, function(doc) {
      ...
      //alert("== doc is xml file string ==" +doc);
      ...
      }  //---- end for: for (var i = 0; i < markers.length; i++)
      ...
      for (var a = 0; a < lines.length; a++) {
        ...
        for (var i = 0; i < points.length; i++) {
           pts[i] = new g.LatLng(parseFloat(points[i].getAttribute("lat")), parseFloat(points[i].getAttribute("lng")));
      ...
      } //---- end of line: for (var a = 0; a < lines.length; a++)
