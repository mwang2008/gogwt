...
function $moduleFunctionName$(){
  ...
  function onBodyDone(){
    if (!bodyDone) {
      bodyDone = true;
      if (!__gwt_stylesLoaded[$intern_85]) {
        var l = $doc.createElement($intern_86);
        __gwt_stylesLoaded[$intern_85] = l;
        l.setAttribute($intern_87, $intern_88);
        l.setAttribute($intern_89, base + $intern_85);
        $doc.getElementsByTagName($intern_90)[0].appendChild(l);
      }
      if (!__gwt_stylesLoaded[$intern_91]) {
        var l = $doc.createElement($intern_86);
        __gwt_stylesLoaded[$intern_91] = l;
        l.setAttribute($intern_87, $intern_88);
        l.setAttribute($intern_89, base + $intern_91);
        $doc.getElementsByTagName($intern_90)[0].appendChild(l);
      }
      maybeStartModule();
