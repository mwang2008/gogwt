   ...
   private HotelSearchDAO hotelSearchDAO;
	...
	public HotelSearchResponseBean findHotelsWithLocation(final SearchFormBean searchFormBean) throws AppRemoteException {
		...
		if (geoCode != null) {
			...
			centerGeocode.setLat(toDouble(geoCode.getLat()));
			centerGeocode.setLng(toDouble(geoCode.getLng()));
		...
		if (searchFormBean.getGeoCode() != null && searchFormBean.getGeoCode().validGeocode()) {
			...
			centerGeocode.setLat(toDouble(searchFormBean.getGeoCode().getLat()));
			centerGeocode.setLng(toDouble(searchFormBean.getGeoCode().getLng()));
