...
/**
 * Receive message pushed from app server
 * @author Michael.Wang
 *
 */
public class C2DMMessageReceiver extends BroadcastReceiver {
	...
	public void onReceive(Context context, Intent intent) {
		...
		GwtLog.d("C2DM", "Message Receiver called");
		if ("com.google.android.c2dm.intent.RECEIVE".equals(action)) {
			Log.w("C2DM", "Received message");
			final String payload = intent.getStringExtra("payload");
			GwtLog.d("C2DM", "---- dmControl: payload = " + payload);
	...
	public void createNotification(Context context, String payload) {
		...
		Notification notification = new Notification(R.drawable.global_gwt,
				"Message received", System.currentTimeMillis());
		// Hide the notification after its selected
		notification.flags |= Notification.FLAG_AUTO_CANCEL;

		Intent intent = new Intent(context, C2DMMessageReceivedActivity.class);
