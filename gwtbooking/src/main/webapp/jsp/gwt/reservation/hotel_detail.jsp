...
<head>
   ...
   <script type="text/javascript" language="javascript" src="${env.contextPath}/com.gogwt.app.booking.gwt.hoteldetail.HotelDetailModule/com.gogwt.app.booking.gwt.hoteldetail.HotelDetailModule.nocache.js"></script>
